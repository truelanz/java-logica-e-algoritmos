...
/*
 * 4º Joaozinho quer calcular e mostrar a quantidade de litros de combustível gastos
...
public class Ex5_GastoCombustivel {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);

        int gastoAutomovel = 12;
        ...
        double distanciaPercorrida = horasDeViagem * velocidadeMediaViagem;
        double gastoNecessario = distanciaPercorrida / gastoAutomovel;

        //System.out.println(distanciaPercorrida);
        System.out.printf("%nQuantidade de litros necessária: %.3f", gastoNecessario);
